...
package com.test.sealing.model;
...
public abstract class BaseVO implements Serializable {
     ...
     * 创建日期
     */
    @ApiModelProperty(value="创建日期",name="createDate",example="CURRENT_TIMESTAMP")
     ...
     * 更新日期
     */
    @ApiModelProperty(value="更新日期",name="updateDate",example="CURRENT_TIMESTAMP")
